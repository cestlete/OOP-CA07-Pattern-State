...
class GameController{
    ...
    static void setState(String gameStateName){
		...
		// (1) If it's not "PointState", the game should be over.
	...
	static void setState(String gameStateName, int rollValue){
		...
		// (2) Calling this method on "pointstate" will cause the game to end (after modification)
...
abstract class CrapsGameState{
	void play(int rolled){ 
		...
		// (3) The gamestate should be judged according to the number of points and different play() methods should be executed
	...
	void doExitStateActivity(){
		; //default: entry/doNothing
		// (4) There should be something in here about "exit the game".
